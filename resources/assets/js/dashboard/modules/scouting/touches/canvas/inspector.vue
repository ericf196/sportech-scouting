                    ...
                    <div class="mailbox-controls control-inspector-menu">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-success btn-sm" v-on:click="play">
                                ...
                                {{playing?$t('scoutings.pause'):$t('scoutings.play')}}
                            </button>
                        </div>
                        <div class="btn-group">
                ...
                <div class="row" v-if="touch">
                    <div class="col-xs-6 no-padding-right">
                        <div class="athlete-menu-title">
                            {{$t('scoutings.left_actions')}}
                        </div>
                    </div>
                    <div class="col-xs-6 no-padding-left">
                        <div class="athlete-menu-title">
                            {{$t('scoutings.right_actions')}}
                        </div>
                    </div>
                </div>
                ...
                <div class="row" v-if="touch">
                    <div class="col-xs-6 no-padding-right">
                        <div class="athlete-menu-left">
                            <tags :tags="tagsLeft" :selected="action.leftTags" type="left"
                                  v-on:tag-deleted="tagDeletedLeft" v-on:tag-selected="tagSelectedLeft"></tags>
                        </div>
                    </div>
                    <div class="col-xs-6 no-padding-left">
                        <div class="athlete-menu-left">
                            <tags :tags="tagsRight" :selected="action.rightTags" type="right"
...
<script>
    ...
    import commonService from 'base/dashboard/services/common/commonService'
    ...
    export default{
        ...
        created(){
            ...
            commonService.getTags((response)=> {
                this.tagsLeft = _.cloneDeep(response.data);
                this.tagsRight = _.cloneDeep(response.data);
            }, (error)=> {
