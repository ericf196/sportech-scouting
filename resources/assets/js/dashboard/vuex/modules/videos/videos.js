...
import videoService from 'base/admin/services/videos/video-service'
...
const actions = {
    [types.actions.create]: (context, payload) => {
        ...
        videoService.create(payload.data, (response) => {
    ...
    [types.actions.update]: (context, payload) => {
        ...
        videoService.update(payload.id, payload.data, (response) => {
    ...
    [types.actions.remove]: (context, payload) => {
        ...
        videoService.remove(payload.data.id, (response) => {
    ...
    [types.actions.show]: (context, payload) => {
        videoService.show(payload.id, (response) => {
