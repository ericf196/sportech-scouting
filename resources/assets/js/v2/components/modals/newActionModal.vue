<template>
    <div>
        <modal :open="open" :complete-callback="close" fixed-footer :dismissible="false">
            <modal-header title="New Action"></modal-header>
            <form class="form" id="new-action-form">
                <modal-content>
                    <div slot="content">
                        <p class="padding-top padding-bottom">Add New Action</p>
...
<script type="text/babel">
    ...
    export default{
        ...
        watch: {
            open(val){
                this.action.start = this.start >= 0 ? this.start : 0
                this.action.end = this.action.start + 100
            }
        },
        data(){
            return {
