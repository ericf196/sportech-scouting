                    ...
                    <div class="alert alert-danger">
                        ...
                        <ul>
                            <li v-for="touch in collideTouches">
                                <strong v-if="touch.previous.hasOwnProperty('id')">{{touch.previous.text}}: that starts
                                    on {{toHHMMSS(touch.previous.start)}} an
                                    ends on
                                    {{toHHMMSS(touch.previous.end)}}</strong>
                                <strong v-if="touch.current.hasOwnProperty('id')">{{touch.current.text}}: that starts on
