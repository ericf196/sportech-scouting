...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form action="{{ url(LaravelLocalization::getLocalizedURL(null,'/password/reset')) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-10">
                        <button type="submit"
                                class="btn btn-primary btn-block btn-flat">{{ trans('message.passwordreset') }}</button>
                    </div><!-- /.col -->
                    <div class="col-xs-1">
                    </div><!-- /.col -->
                </div>
